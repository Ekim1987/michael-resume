...
const Profile = props => {
    ...
    return  <div>
                  ...
                  <ul className="list-unstyled contact-links text-center">
                    <li><i className="fa fa-lg fa-location-arrow"></i>{profileObj.location.address}, {profileObj.location.suburb}, {profileObj.location.city}</li>
                  ...
                  <ul className="profileLinks list-inline text-center">
                    ...
                    <li><a className="fa fa-facebook fa-2x" href={'https://www.facebook.com/'+profileObj.profiles[1].username}></a></li>
                  </ul>
                  <div className="divider"></div>
